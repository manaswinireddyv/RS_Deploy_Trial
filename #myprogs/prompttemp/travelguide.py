...
prompt_template=PromptTemplate(
    ...
    If you're visiting in {month} for {no_of_days}, here's what you can do:
...
if city and month and language and budget and no_of_days:
    resp=llm.invoke(prompt_template.format(city=city,month=month,
